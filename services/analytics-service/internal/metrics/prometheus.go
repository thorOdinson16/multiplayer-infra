...
func Handler(m *consumer.Metrics) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		m.Lock()
		defer m.Unlock()
		fmt.Fprintf(w, "# HELP analytics_events_total Total telemetry events\n")
		fmt.Fprintf(w, "# TYPE analytics_events_total counter\n")
		fmt.Fprintf(w, "analytics_events_total %d\n", m.TotalEvents)
